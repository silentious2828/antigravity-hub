# Application Package — AWS
**Target Role:** Principal Partner Development / AI  
**Candidate:** Sam Leong  
**Status:** 🟢 SSOT v2.4-ST DEPLOYMENT-READY

## Package Contents
1. `CV_5_AWS_Principal_Partner_Development_AI.md` — ERP Modernization & AI CV (SSOT-aligned)
...
1. Use `CV_5_AWS_Principal_Partner_Development_AI.md` as primary
2. Attach CV + Cover Letter Master to application portal
3. Emphasize SAP MM certification, partner development, and AI integration
