# Application Package — TikTok
**Target Role:** Eco Project Manager / Digital Transformation  
**Candidate:** Sam Leong  
**Status:** 🟢 SSOT v2.4-ST DEPLOYMENT-READY

## Package Contents
1. `CV_4_TikTok_Eco_Project_Manager.md` — Digital Transformation CV (SSOT-aligned)
...
1. Use `CV_4_TikTok_Eco_Project_Manager.md` as primary
2. Attach CV + Cover Letter Master to application portal
3. Emphasize AI workflow orchestration and digital transformation metrics
